...
@export var coussin: Mobilier   # Référence au coussin cible (assignée dans l'éditeur)
...
var sur_coussin := false  # True quand le chat a atteint physiquement le coussin (utilisé par BTA_DormirCoussin)
